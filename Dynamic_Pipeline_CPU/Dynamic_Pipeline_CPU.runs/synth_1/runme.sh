...
HD_PWD='D:/Dynamic_Pipeline_CPU/Dynamic_Pipeline_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcpu_onboard.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dcpu_onboard.tcl
