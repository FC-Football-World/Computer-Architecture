...
HD_PWD='D:/Dynamic_Pipeline_CPU/Dynamic_Pipeline_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dcpu_onboard.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dcpu_onboard.tcl -notrace
